...
Every script generated by EnvForge passes through a two-stage `SafetyFilter`
in `backend/app/templates/safety.py` before being returned to the client.
This is a **hard gate** — no script can reach the user without passing both stages.

### How It Works

**Stage 1 — Regex Pattern Matching**

Each line of the rendered script is scanned against a list of compiled regular
...
Regex allows fast, stateless, line-by-line scanning of shell scripts without
executing them. Key properties of the implementation:
